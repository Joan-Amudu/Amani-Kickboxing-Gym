...
# General Information
This project is to build a static front-end website to present useful information to users.
...
- [Email address](mailto:info@amanikickboxing.com) - a business email that the user can to contact the gym.
